 ...
 *
 * El dashboard corre en la misma red local que el backend (sin salida a
 * internet). API_BASE apunta por defecto a localhost:8000; ajustar si el
 * backend corre en otra IP del nodo Jetson Orin.
 */

const API_BASE = window.VIGILIA_API_BASE || "http://localhost:8000";
